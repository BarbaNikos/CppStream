...
class Util {
 public:
  ...
  static void get_files(std::vector<std::string>& file_list,
...
typedef struct task_event_str {
  ...
  std::string serialize() const {
    std::string s =
        std::to_string(timestamp) + "," + std::to_string(missing_info) + "," +
        std::to_string(job_id) + "," + std::to_string(task_index) + "," +
        std::to_string(machine_id) + "," + std::to_string(event_type) + "," +
        user_name + "," + std::to_string(scheduling_class) + "," +
        std::to_string(priority) + "," + std::to_string(cpu_request) + "," +
        std::to_string(ram_request) + "," + std::to_string(disk_request) + "," +
  ...
  int scheduling_class;   // not required 7 (category based on saber paper
                          // definition)
...
inline bool Experiment::GoogleClusterMonitor::Util::ends_with(
...
inline void Experiment::GoogleClusterMonitor::Util::get_files(
