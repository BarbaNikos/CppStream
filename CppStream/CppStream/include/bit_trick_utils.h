...
inline uint8_t BitWizard::max_uint8(uint8_t x, uint8_t y)
{
	return x ^ ((x ^ y) & -(x < y)); // max(x, y)
}

inline uint16_t BitWizard::max_uint16(uint16_t x, uint16_t y)
{
	return x ^ ((x ^ y) & -(x < y)); // max(x, y)
}
...
inline uint8_t BitWizard::min_uint8(uint8_t x, uint8_t y)
{
	return y ^ ((x ^ y) & -(x < y)); // min(x, y)
}

inline uint16_t BitWizard::min_uint16(uint16_t x, uint16_t y)
{
	return y ^ ((x ^ y) & -(x < y)); // min(x, y)
}
...
inline uint8_t BitWizard::highest_order_bit_index_arch(uint8_t value)
{
	...
	return lz != 0 ? s >> lz : 0x00;
	// return value != 0 ? s >> lzcnt8(value) : 0x00;
}

inline uint16_t BitWizard::highest_order_bit_index_arch(uint16_t value)
{
	uint16_t s = 0x8000;
	uint16_t lz = lzcnt16(16);
	return lz != 0 ? s >> lz : 0x0000;
	// return value != 0 ? s >> lzcnt16(value) : 0x0000;
}
...
inline uint32_t BitWizard::highest_order_bit_index_arch(uint32_t value)
{
	...
	return lz != 0 ? s >> lz : 0x00000000;
	// return value != 0 ? s >> lzcnt32(value) : 0x00000000;
}
...
inline uint64_t BitWizard::highest_order_bit_index_arch(uint64_t value)
{
	...
	return lz != 0 ? s >> lz : 0x0000000000000000;
	// return value != 0 ? s >> lzcnt64(value) : 0x0000000000000000;
}