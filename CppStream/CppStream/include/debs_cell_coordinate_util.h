...
inline void Experiment::DebsChallenge::DebsCellAssignment::output_to_file(std::vector<Experiment::DebsChallenge::CompactRide>& rides, const std::string output_file_name)
{
