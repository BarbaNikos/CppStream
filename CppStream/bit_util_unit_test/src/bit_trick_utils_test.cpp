...
TEST(SwapBits32, Simple)
{
	EXPECT_EQ(0, BitWizard::swap_bits_32(0));
}
...
{
	EXPECT_EQ(BitWizard::lowest_order_bit_index_slow((uint16_t)0x0800), BitWizard::lowest_order_bit_index((uint16_t)0x0800));
	EXPECT_EQ(BitWizard::lowest_order_bit_index_slow((uint16_t)0x0000), BitWizard::lowest_order_bit_index((uint16_t)0x0000));
}

TEST(LowestOrderBit, Intrinsic)
{
	EXPECT_EQ(BitWizard::lowest_order_bit_index_slow((uint16_t)0x0800), BitWizard::lowest_order_bit_index_arch((uint16_t)0x0800));
	EXPECT_EQ(BitWizard::lowest_order_bit_index_slow((uint16_t)0x0000), BitWizard::lowest_order_bit_index_arch((uint16_t)0x0000));
}

TEST(HighestOrderBit, Simple)
{
	EXPECT_EQ(BitWizard::highest_order_bit_index_slow((uint16_t)0x0800), BitWizard::highest_order_bit_index((uint16_t)0x0800));
	EXPECT_EQ(BitWizard::highest_order_bit_index_slow((uint16_t)0x0000), BitWizard::highest_order_bit_index((uint16_t)0x0000));
}

TEST(HighestOrderBit, Intrinsic)
{
	EXPECT_EQ(BitWizard::highest_order_bit_index_slow((uint16_t)0x0800), BitWizard::highest_order_bit_index_arch((uint16_t)0x0800));
	EXPECT_EQ(BitWizard::highest_order_bit_index_slow((uint16_t)0x0000), BitWizard::highest_order_bit_index_arch((uint16_t)0x0000));
}