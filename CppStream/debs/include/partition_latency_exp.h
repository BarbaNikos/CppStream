...
namespace Experiment
{
	namespace DebsChallenge
	{
		...
		{
		public:
			static void measure_latency(size_t task_number, const std::vector<CompactRide>& frequent_ride_table)
			{
				...
				const std::vector<CompactRide>& frequent_ride_table)
			{
				...
				for (size_t iteration = 0; iteration < 5; ++iteration)
				{
					...
					ninety_pile_durations.push_back(StreamPartitionLib::Stats::Util::get_percentile(durations, 0.9));
					ninetynine_pile_durations.push_back(StreamPartitionLib::Stats::Util::get_percentile(durations, 0.99));
					median_durations.push_back(StreamPartitionLib::Stats::Util::get_percentile(durations, 0.5));
					mean_durations.push_back(StreamPartitionLib::Stats::Util::get_mean(durations));
					durations.clear();
					window_buffer.clear();
				}
				...
				float mean_latency = StreamPartitionLib::Stats::Util::get_mean(mean_durations);
				float median_latency = StreamPartitionLib::Stats::Util::get_mean(median_durations);
				float ninety_ile_latency = StreamPartitionLib::Stats::Util::get_mean(ninety_pile_durations);
				float ninetynine_ile_latency = StreamPartitionLib::Stats::Util::get_mean(ninetynine_pile_durations);
